...
var CNExtend_enum = new function() {
	...
	this.validationStatus = { Invalid: 0, NotValidated : 11, Pending: 12, Validated: 13, Unknown: 14, GaveUp: 15};
	this.gameType = { Invalid: 0, Standard : 11, Tournament : 12};
	this.tableMode = { Invalid: 0, Normal: 1, Edit: 2};
	this.website = "http://www.babelphish.net/cnextend/";
	this.APIURL = "http://cnextend.appspot.com/api/"
	this.secureAPIURL = "https://cnextend.appspot.com/api/secure/"
	this.testAPIURL = "http://localhost:8080/api/"
	this.testSecureAPIURL = "http://localhost:8080/api/secure/"
	...
	this.VALIDATION_STATUS_PREF = _prefPrefix + "validationStatus";
